...
class CLEXScalingRotaryEmbedding(nn.Module):
    ...
    def __init__(self, dim, 
                 ...
                 rope_scaling_max_factor=8.0, 
                 rope_scaling_param_factor=1.0, 
                 base=10000, device=None) -> None:
        super().__init__()

        self.max_t = rope_scaling_max_factor
        self.dim = dim
        ...
        self.proj_func = ODELinear(dim, rope_scaling_param_factor)
